	...
	$.fn.prettyEmbed = function (options) {
		...
		elem.each(function() {
			...
			if ( thisCustomPreviewImage !== undefined && thisCustomPreviewImage !== '' ) {
				...
				$(this).html('<img src="https://img.youtube.com/vi/' + thisVideoID + '/' + previewSizePrefix + '.jpg" width="100%" alt="YouTube Video Preview" />');
			}
		...
		function clickEventRunner(obj) {
			...
			obj.html('<iframe width="' + wrapperWidth + '" height="' + wrapperHeight + '" ' + fullScreenFlag + 'style="border:none;" src="https://www.youtube.com/embed/' + thisVideoID + '?autoplay=1' + playerOptions + '"></iframe>')
